import { Box, Flex, Heading, Image, Grid, GridItem, Text } from "@chakra-ui/react";
        ...
        <>
            ...
            <Flex w={'100vw'} mb="4rem" flexDir={'column'} gap={20}>
                ...
                gap={5}>
                    ...
                    <GridItem bg={'brand.darkGreen'} rowSpan={2} py={10} colSpan={8} borderRadius={10} display={'flex'} flexDir={'column'} justifyContent={'center'} alignItems={'center'}>
                        <Box>
                            <Box w={'28vw'}>
                    ...
                    <Flex overflow={'hidden'} py={10} display={'flex'} justifyContent={'center'} pos={'relative'}>
