...
import { getBestsellerProducts } from "../services/ProductsService";
...
const Home = () => {
  ...
  const fetchBestsellers = async () => {
    try {
      ...
      const filtered = response.content.filter((p) => p.bestseller);
      ...
      <Flex w={"100vw"} mb="4rem" flexDir={"column"} gap={20}>
        ...
        >
          ...
          >
            <Box>
              <Box w={"28vw"}>
                <Heading fontSize={"3.5rem"} color={"brand.lightBeige"}>
                  Nuestras categorias
                </Heading>
                <Text color={"brand.lightBeige"}>
                  Descubre nuestra variedad de categorías para mascotas y
                  encuentra todo lo que necesitas para consentir a tu compañero
                  peludo en un solo lugar.
                </Text>
              </Box>
        ...
        >
          ...
          <BestSellers
            ...
            description={
              "Descubre los artículos imprescindibles para tu mascota. Desde juguetes interactivos hasta cómodas camas, encuentra todo lo que necesitas para cuidar y mimar a tu compañero peludo. ¡Calidad garantizada y precios irresistibles!"
            }
          />
        </Skeleton>
      </Flex>
