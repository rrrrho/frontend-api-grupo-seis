  ...
  return (
    <>
        ...
        <Flex justify="center" align="center" w="100vw" h="80vh">
            <Skeleton as={Flex} isLoaded={!isLoading} startColor='brand.darkGreen' endColor='brand.lightGreen' w={{ base: '30rem', xl: "50rem" }} bg="brand.lightBeige" borderRadius="15px" position="relative" transition="all 0.2s">
