import { Box, Button, Flex, Heading, SimpleGrid, Text, Image, Spinner, Center } from '@chakra-ui/react';
        ...
        <>
            ...
            <Box my="5rem">
                <Box bg="brand.lightGreen" h="35vh" position="relative">
                    <Box position="absolute" bottom="-1" left={{"lg": "3%", "xl": "12%"}} h={{"lg": "120%", "xl": "110%"}} >
                        <Image src="src/assets/img/dog-banner.svg" objectFit="cover" h="100%" w="100%"></Image>
                    </Box>
                </Box>
                <Flex justifyContent="center" mt="3rem" gap={20}>
                    <Flex gap={5} w="22vw" flexDir="column">
                        ...
                        <Box>
                            <Image src="src/assets/img/dogs/dog-poster.png" w="22vw"  objectFit="cover"></Image>
                        </Box>
                    </Flex>
                    <Flex flexDir="column">
                        ...
                        <Text fontSize="1.1rem" ml="0.5rem">16789 productos</Text>
