...
const AddToCart = ({id, name, price, image, rating, voters, discount, quota, stock, bestseller}: Product) => {
    ...
    return (
        <>
            <Button position="absolute" bottom={{base: '46%', xl: "45%"}} left="77%" borderRadius="100%" bg="brand.lightBeige" w={{base: '2rem', xl: "3rem"}} h={{base: '2rem', xl: "3rem"}} cursor="pointer" onClick={()=> addItemToCart()} _hover="none">
                <Icon as={AiFillShopping} color="brand.darkBrown" boxSize={{base: '6', xl: "7"}}/>
            </Button>
